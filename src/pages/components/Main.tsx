...
export default function Main() {
  ...
  const [commentbarList, setcommentbarList] = useState([]);
  const [commentLikeList, setcommentLikeList] = useState([]);
  const [likeList, setlikeList] = useState([]);
  const [validpost, setvalidpost] = useState(false);
  const [update, setupdate] = useState(false);
  const [elements, setElements] = useState([]);
  const [commentsSectionList, setcommentsSectionList] = useState([]);
          ...
          <CardBody>
            <Stack divider={<StackDivider />} spacing="4">
              ...
              {postImage !== "" ? (
                ...
                >
                  <Image width="70" height="70" unoptimized src={postImage} />
                  <IconButton
